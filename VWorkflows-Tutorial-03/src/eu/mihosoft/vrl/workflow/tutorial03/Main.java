 ...
 */
package eu.mihosoft.vrl.workflow.tutorial03;
...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        showFlow(flow, primaryStage, "VWorkflows Tutorial 03: View 1");
        
        // show the main stage/window
        showFlow(flow, new Stage(), "VWorkflows Tutorial 03: View 2");
